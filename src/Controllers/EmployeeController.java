...
public class EmployeeController {
    ...
    @FXML
    private JFXButton searchEmpBtn;
    ...
    @FXML
    private JFXButton searchEmpsBtn;
    ...
    @FXML
    private TableColumn<Employee, Integer> empDeptIDColumn;
    ...
    private void initialize () {
        ...
        */
        ...
        empDeptIDColumn.setCellValueFactory(cellData -> cellData.getValue().departmentIdProperty().asObject());
    ...
    private void insertEmployee (ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        try {
            EmployeeDAO.insertEmp(nameText.getText(),surnameText.getText(),emailText.getText(),Integer.valueOf(DeptidText.getText()));
